...
class _CoinsClient implements CoinsClient {
  ...
  Future<CoinModel> getAllCoins({
    ...
    final _options = _setStreamType<CoinModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late CoinModel _value;
    try {
      _value = CoinModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<MarketCapDto> getMarketCap() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MarketCapDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MarketCapDto _value;
    try {
      _value = MarketCapDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<TransactionModel> getTransactions({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TransactionModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<WalletStatusModel> getWalletStatus({required String address}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WalletStatusModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late WalletStatusModel _value;
    try {
      _value = WalletStatusModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PatchTransactionsModel> patchTransactions({required String address}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PatchTransactionsModel>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PatchTransactionsModel _value;
    try {
      _value = PatchTransactionsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
