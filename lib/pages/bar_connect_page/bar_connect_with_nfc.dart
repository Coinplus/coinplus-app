...
@RoutePage()
class BarConnectWithNfc extends StatefulWidget {
  const BarConnectWithNfc({
    super.key,
    this.receivedData,
    this.barColor,
    this.isOriginalTag,
  ...
  @override
  State<BarConnectWithNfc> createState() => _BarConnectWithNfcState();
}

class _BarConnectWithNfcState extends State<BarConnectWithNfc> with TickerProviderStateMixin {
        ...
        title: Row(
          children: [
            Theme(
              ...
              child: IconButton(
                onPressed: () {
                  _allSettingsState.isLineVisible ? makeLineInvisible() : router.maybePop();
                },
