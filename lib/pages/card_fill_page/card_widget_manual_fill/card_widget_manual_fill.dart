...
class CardWidgetManual extends StatefulWidget {
  const CardWidgetManual({
    super.key,
  ...
  @override
  State<CardWidgetManual> createState() => _CardWidgetManualState();
}

class _CardWidgetManualState extends State<CardWidgetManual> {
  @override
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.white,
                                    border: Border.all(
                                      color: widget.focusNode.hasFocus ? Colors.blue : const Color(0xFFFBB270),
