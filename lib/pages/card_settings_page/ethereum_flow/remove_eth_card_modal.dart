...
class RemoveEthCard extends StatefulWidget {
  const RemoveEthCard({super.key, required this.ethCard});

  final EthCardModel ethCard;

  @override
  State<RemoveEthCard> createState() => _RemoveCardState();
}

class _RemoveCardState extends State<RemoveEthCard>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Gap(25),
          ActionSliderForEthCardDelete(
            balanceStore: _balanceStore,
            ethCard: widget.ethCard,
          ...
          LoadingButton(
            onPressed: () async {
              ...
              await recordAmplitudeEventPartTwo(
                NotSureClicked(
                  walletAddress: widget.ethCard.address,
                  walletType: 'Card',
