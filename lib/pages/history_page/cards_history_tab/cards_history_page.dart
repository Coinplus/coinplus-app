...
class _CardsHistoryPageState extends State<CardsHistoryPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return ReactionBuilder(
      builder: (context) {
        return reaction((p0) => state.historyPageStore.isCardRefreshing, (isCardRefreshing) async {
          if (!isCardRefreshing) {
            _controller
              ..stop()
              ..reset();
                  ...
                  Observer(
                    builder: (context) {
                      return AnimatedSwitcher(
                        ...
                        child: (state.historyPageStore.cardHistories[
                                    state.balanceStore.cards[state.historyPageStore.cardHistoryIndex].address] ==
                                null
                            ? const Padding(
                            ...
                            : Observer(
                                builder: (context) {
                                  ...
                                  if (state.historyPageStore.cardsTransactions!.isEmpty) {
                                    return Align(
                                      alignment: Alignment.bottomCenter,
                                      child: Column(
                                        children: [
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            ...
                                                            LoadingButton(
                                                              ...
                                                              onPressed: () {
                                                                state.historyPageStore.fetchCardNextPageTransactions(
