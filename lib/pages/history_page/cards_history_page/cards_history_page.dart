...
class CardsHistoryPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      onRefresh: () async {
        ...
        await historyPageStore.onCardRefresh(
          address: balanceStore.cards[historyPageStore.cardHistoryIndex].address,
        );
      },
      child: balanceStore.cards.isEmpty
          ? Align(
                    ...
                    builder: (context) {
                      return historyPageStore.historyLoading == true
                          ...
                          : Observer(
                              builder: (context) {
                                final transactions =
                                    historyPageStore.cardHistories[historyPageStore.cardSelectedAddress]?.result;
                      ...
                      return Positioned(
                        ...
                        child: ScaleTap(
                          ...
                          onPressed: historyPageStore
                                      .disabledButtons[balanceStore.cards[historyPageStore.cardHistoryIndex].address] ??
                                  false
                              ? () async {
                              ...
                              : () async {
                                  ...
                                  historyPageStore.disabledButtons[
                                      balanceStore.cards[historyPageStore.cardHistoryIndex].address] = true;
                                  ...
                                  historyPageStore.disabledButtons[
                                      balanceStore.cards[historyPageStore.cardHistoryIndex].address] = false;
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Observer(
                                    builder: (_) => Text(
                                      historyPageStore.getLastRefreshed(historyPageStore.cardSelectedAddress),
                                      style: const TextStyle(
                                        fontFamily: FontFamily.redHatMedium,
                                        fontSize: 10,
                                        color: Color(0xFF838995),
  ...
  Future<void> refresh() async {
    try {
      await historyPageStore.refresh(balanceStore.cards[historyPageStore.cardHistoryIndex].address);
    } catch (e) {
      log(e.toString());
    } finally {
