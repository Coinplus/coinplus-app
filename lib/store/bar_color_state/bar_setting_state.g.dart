...
mixin _$BarSettingState on _BarSettingState, Store {
  late final _$selectedColorAtom = Atom(name: '_BarSettingState.selectedColor', context: context);
  ...
  late final _$changeColorAsyncAction = AsyncAction('_BarSettingState.changeColor', context: context);
