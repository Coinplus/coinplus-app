...
import 'nav_bar_state/nav_bar_state.dart';
...
void registerStoreGetIt() {
  ...
  GetIt.I.registerSingleton(NavBarState());
}
...
void reRegisterStoreGetIt() {
  ...
  final _navBarState = GetIt.I<NavBarState>();
  ...
  GetIt.I.unregister(instance: _navBarState);
  registerStoreGetIt();
}
