...
mixin _$CardAnimationState on _CardAnimationState, Store {
  late final _$_showFirstWidgetAtom = Atom(name: '_CardAnimationState._showFirstWidget', context: context);
  ...
  late final _$_CardAnimationStateActionController = ActionController(name: '_CardAnimationState', context: context);

  @override
  void startLoading() {
    final _$actionInfo = _$_CardAnimationStateActionController.startAction(name: '_CardAnimationState.startLoading');
    try {
