...
mixin _$SettingsState on _SettingsState, Store {
  late final _$cardCurrentIndexAtom = Atom(name: '_SettingsState.cardCurrentIndex', context: context);
  ...
  late final _$barCurrentIndexAtom = Atom(name: '_SettingsState.barCurrentIndex', context: context);
  ...
  late final _$cardAndBarTabBarIndexAtom = Atom(name: '_SettingsState.cardAndBarTabBarIndex', context: context);
  ...
  late final _$isAddressCopiedAtom = Atom(name: '_SettingsState.isAddressCopied', context: context);
  ...
  late final _$isReorderingStartAtom = Atom(name: '_SettingsState.isReorderingStart', context: context);
  ...
  late final _$setCardCurrentIndexAsyncAction = AsyncAction('_SettingsState.setCardCurrentIndex', context: context);
  ...
  late final _$setBarCurrentIndexAsyncAction = AsyncAction('_SettingsState.setBarCurrentIndex', context: context);
  ...
  late final _$copyAddressAsyncAction = AsyncAction('_SettingsState.copyAddress', context: context);
  ...
  late final _$changeTabBarIndexAsyncAction = AsyncAction('_SettingsState.changeTabBarIndex', context: context);

  @override
  Future<void> changeTabBarIndex(int index) {
    return _$changeTabBarIndexAsyncAction.run(() => super.changeTabBarIndex(index));
  }

  late final _$_SettingsStateActionController = ActionController(name: '_SettingsState', context: context);

  @override
  void startReorder() {
    final _$actionInfo = _$_SettingsStateActionController.startAction(name: '_SettingsState.startReorder');
    try {
