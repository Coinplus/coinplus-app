...
mixin _$CardNameState on _CardNameState, Store {
  late final _$isButtonEnabledAtom =
      Atom(name: '_CardNameState.isButtonEnabled', context: context);
  ...
  late final _$_CardNameStateActionController =
      ActionController(name: '_CardNameState', context: context);

  @override
  bool isEmpty() {
    final _$actionInfo = _$_CardNameStateActionController.startAction(
        name: '_CardNameState.isEmpty');
    try {
