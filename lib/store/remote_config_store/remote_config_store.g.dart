...
mixin _$RemoteConfigStore on _RemoteConfigStore, Store {
  late final _$showAlertAtom = Atom(name: '_RemoteConfigStore.showAlert', context: context);
  ...
  late final _$_initAsyncAction = AsyncAction('_RemoteConfigStore._init', context: context);
