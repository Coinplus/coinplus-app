...
part of 'eth_card_settings_state.dart';
...
mixin _$EthCardSettingState on _EthCardSettingState, Store {
  late final _$selectedCardColorAtom =
      Atom(name: '_EthCardSettingState.selectedCardColor', context: context);
  ...
  late final _$isColorChangedAtom =
      Atom(name: '_EthCardSettingState.isColorChanged', context: context);
  ...
  late final _$isPrivateKeyVisibleAtom =
      Atom(name: '_EthCardSettingState.isPrivateKeyVisible', context: context);
  ...
  late final _$changeCardColorAsyncAction =
      AsyncAction('_EthCardSettingState.changeCardColor', context: context);
  ...
  late final _$_EthCardSettingStateActionController =
      ActionController(name: '_EthCardSettingState', context: context);

  @override
  void makePrivateVisible() {
    final _$actionInfo = _$_EthCardSettingStateActionController.startAction(
        name: '_EthCardSettingState.makePrivateVisible');
    try {
      return super.makePrivateVisible();
    } finally {
      _$_EthCardSettingStateActionController.endAction(_$actionInfo);
    }
  }
  ...
  void colorState() {
    final _$actionInfo = _$_EthCardSettingStateActionController.startAction(
        name: '_EthCardSettingState.colorState');
    try {
