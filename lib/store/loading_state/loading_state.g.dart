...
mixin _$LoadingState on _LoadingState, Store {
  late final _$isLoadingAtom = Atom(name: '_LoadingState.isLoading', context: context);
  ...
  @override
  void startLoading() {
    final _$actionInfo = _$_LoadingStateActionController.startAction(name: '_LoadingState.startLoading');
    try {
  ...
  @override
  void stopLoading() {
    final _$actionInfo = _$_LoadingStateActionController.startAction(name: '_LoadingState.stopLoading');
    try {
