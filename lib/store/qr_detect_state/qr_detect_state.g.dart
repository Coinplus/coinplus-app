...
mixin _$ValidationState on _ValidationState, Store {
  ...
  late final _$secretOneVisibilityAtom = Atom(name: '_ValidationState.secretOneVisibility', context: context);
  ...
  late final _$secretTwoVisibilityAtom = Atom(name: '_ValidationState.secretTwoVisibility', context: context);
  ...
  late final _$walletAddressAtom = Atom(name: '_ValidationState.walletAddress', context: context);
  ...
  void setWalletAddress({required String publicKey}) {
    final _$actionInfo = _$_ValidationStateActionController.startAction(name: '_ValidationState.setWalletAddress');
    try {
      return super.setWalletAddress(publicKey: publicKey);
    } finally {
      _$_ValidationStateActionController.endAction(_$actionInfo);
    }
  }
  ...
  void makeSecretOneVisible() {
    final _$actionInfo = _$_ValidationStateActionController.startAction(name: '_ValidationState.makeSecretOneVisible');
    try {
  ...
  void makeSecretTwoVisible() {
    final _$actionInfo = _$_ValidationStateActionController.startAction(name: '_ValidationState.makeSecretTwoVisible');
    try {
