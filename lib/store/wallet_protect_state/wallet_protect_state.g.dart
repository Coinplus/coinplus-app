...
mixin _$WalletProtectState on _WalletProtectState, Store {
  ...
  late final _$isSwitchedHideBalancesToggleAtom =
      Atom(name: '_WalletProtectState.isSwitchedHideBalancesToggle', context: context);

  @override
  bool get isSwitchedHideBalancesToggle {
    _$isSwitchedHideBalancesToggleAtom.reportRead();
    return super.isSwitchedHideBalancesToggle;
  }

  @override
  set isSwitchedHideBalancesToggle(bool value) {
    _$isSwitchedHideBalancesToggleAtom.reportWrite(value, super.isSwitchedHideBalancesToggle, () {
      super.isSwitchedHideBalancesToggle = value;
    });
  }
  ...
  late final _$checkHideBalancesToggleStatusAsyncAction =
      AsyncAction('_WalletProtectState.checkHideBalancesToggleStatus', context: context);

  @override
  Future<void> checkHideBalancesToggleStatus() {
    return _$checkHideBalancesToggleStatusAsyncAction.run(() => super.checkHideBalancesToggleStatus());
  }
  ...
  late final _$hideBalancesAsyncAction = AsyncAction('_WalletProtectState.hideBalances', context: context);

  @override
  Future<void> hideBalances() {
    return _$hideBalancesAsyncAction.run(() => super.hideBalances());
  }

  late final _$showBalancesAsyncAction = AsyncAction('_WalletProtectState.showBalances', context: context);

  @override
  Future<void> showBalances() {
    return _$showBalancesAsyncAction.run(() => super.showBalances());
  }
...
isSwitchedHideBalancesToggle: ${isSwitchedHideBalancesToggle},
