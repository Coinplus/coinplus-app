...
mixin _$WalletProtectState on _WalletProtectState, Store {
  ...
  late final _$isSwitchedHideBalancesToggleAtom = Atom(
      name: '_WalletProtectState.isSwitchedHideBalancesToggle',
      context: context);
  ...
  set isSwitchedHideBalancesToggle(bool value) {
    _$isSwitchedHideBalancesToggleAtom
        .reportWrite(value, super.isSwitchedHideBalancesToggle, () {
  ...
  late final _$checkHideBalancesToggleStatusAsyncAction = AsyncAction(
      '_WalletProtectState.checkHideBalancesToggleStatus',
      context: context);

  @override
  Future<void> checkHideBalancesToggleStatus() {
    return _$checkHideBalancesToggleStatusAsyncAction
        .run(() => super.checkHideBalancesToggleStatus());
  }
  ...
  late final _$hideBalancesAsyncAction =
      AsyncAction('_WalletProtectState.hideBalances', context: context);
  ...
  late final _$showBalancesAsyncAction =
      AsyncAction('_WalletProtectState.showBalances', context: context);
