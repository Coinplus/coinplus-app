...
mixin _$ChangePinCodeState on _ChangePinCodeState, Store {
  late final _$isNewPinMatchedAtom = Atom(name: '_ChangePinCodeState.isNewPinMatched', context: context);
  ...
  late final _$newPinMatchAsyncAction = AsyncAction('_ChangePinCodeState.newPinMatch', context: context);
