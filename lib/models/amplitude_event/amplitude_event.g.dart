...
_$IneedToSendNowImpl _$$IneedToSendNowImplFromJson(Map json) => _$IneedToSendNowImpl(
      eventType: json['eventType'] as String? ?? 'I_NEED_TO_SEND_NOW',
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$$IneedToSendNowImplToJson(_$IneedToSendNowImpl instance) => <String, dynamic>{
      'eventType': instance.eventType,
      'runtimeType': instance.$type,
    };

_$IneedToSendGotItImpl _$$IneedToSendGotItImplFromJson(Map json) => _$IneedToSendGotItImpl(
      eventType: json['eventType'] as String? ?? 'I_NEED_TO_SEND_GOT_IT',
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$$IneedToSendGotItImplToJson(_$IneedToSendGotItImpl instance) => <String, dynamic>{
      'eventType': instance.eventType,
      'runtimeType': instance.$type,
    };
...
_$OnboardingStartedImpl _$$OnboardingStartedImplFromJson(Map json) => _$OnboardingStartedImpl(
      eventType: json['eventType'] as String? ?? 'ONBOARDING_STARTED',
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$$OnboardingStartedImplToJson(_$OnboardingStartedImpl instance) => <String, dynamic>{
      'eventType': instance.eventType,
      'runtimeType': instance.$type,
    };
...
Map<String, dynamic> _$$WalletOpenedImplToJson(_$WalletOpenedImpl instance) => <String, dynamic>{
      'eventType': instance.eventType,
      'runtimeType': instance.$type,
    };
